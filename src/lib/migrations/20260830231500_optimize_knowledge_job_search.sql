-- Keep knowledge-aware retrieval on the indexed trigram search path. The
-- previous position() predicate forced a scan and could hit statement_timeout
-- for broad keywords under modest concurrency.

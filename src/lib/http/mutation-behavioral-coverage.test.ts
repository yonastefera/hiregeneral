...
const behavioralCoverage: Record<string, string> = {
  ...
  "app/api/employers/applications/[id]/scorecards/route.ts":
    "app/api/employers/applications/[id]/scorecards/route.test.ts",
  "app/api/employers/pipeline/route.ts":
    "app/api/employers/pipeline/route.test.ts",
  "app/api/employers/team/route.ts": "app/api/employers/team/route.test.ts",

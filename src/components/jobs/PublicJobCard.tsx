      ...
      <div className="sm:hidden">
        <div className="flex items-start justify-between gap-3">
          ...
          <Link
            ...
            aria-label="Save job"
            className={cn(
              "relative z-10 grid size-10 shrink-0 place-items-center rounded-2xl border border-border/60 bg-transparent text-muted-foreground transition-colors",
              "hover:bg-secondary hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 sm:border-transparent sm:hover:bg-transparent",
            )}
          >
